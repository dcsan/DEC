  ...
  return (
    <div style={shell(ACCENT)}>
      ...
      <div style={{ padding: 10 }}>
        <div style={{ fontSize: 11, fontWeight: 600, marginBottom: 4, color: "var(--vizithink-text-subtle)" }}>Root</div>
        <input
          value={root}
        ...
        />
        <div style={{ fontSize: 11, fontWeight: 600, marginBottom: 6, color: "var(--vizithink-text-subtle)" }}>Branches</div>
        {branches.map((b, i) => (
          <div key={i} style={{ marginBottom: 8, padding: 8, borderRadius: 8, border: "1px solid var(--vizithink-border)" }}>
            <input
              value={b.condition}
